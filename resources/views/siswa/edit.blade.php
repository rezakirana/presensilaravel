            ...
            <form role="form" method="post" action="{{ route('siswa.update', $siswa->id) }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" name="tahun_masuk" id="tahun_masuk"value="{{ $siswa->tahun_masuk  }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPendidikanTerakhir">Tanggal Lahir pppp</label>
                        <div class="input-group date col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control pull-right datepicker"  name="tgl_lahir"  value="{{ $siswa->tgl_lahir  }}" required>
                        </div>
                    </div>
                    <div class="form-group">
